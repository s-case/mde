...
import ServicePSM.JavaFunction;
 ...
 * @generated
 */
public class ServicePSMPackageImpl extends EPackageImpl implements ServicePSMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ServicePSM.ServicePSMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ServicePSMPackageImpl() {
		super(eNS_URI, ServicePSMFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ServicePSMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ServicePSMPackage init() {
		if (isInited) return (ServicePSMPackage)EPackage.Registry.INSTANCE.getEPackage(ServicePSMPackage.eNS_URI);

		// Obtain or create and register package
		ServicePSMPackageImpl theServicePSMPackage = (ServicePSMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ServicePSMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ServicePSMPackageImpl());
		...
		EValidator.Registry.INSTANCE.put
			(theServicePSMPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return ServicePSMValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theServicePSMPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ServicePSMPackage.eNS_URI, theServicePSMPackage);
		return theServicePSMPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaRModel() {
		return (EReference)resTfulServicePSMEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaRController() {
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaRCManager() {
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaRMManager() {
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaAlgoModel() {
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasJavaAlgoController() {
	 ...
	 * @generated
	 */
	public EReference getRESTfulServicePSM_HasHibernateController() {
	...
	public EAttribute getRESTfulServicePSM_Name() {
		return (EAttribute)resTfulServicePSMEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public ServicePSMFactory getServicePSMFactory() {
		return (ServicePSMFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_RMODEL);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_RCONTROLLER);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_RC_MANAGER);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_RM_MANAGER);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_MODEL);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_CONTROLLER);
		createEReference(resTfulServicePSMEClass, RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER);
	...
	public void initializePackageContents() {
		...
		initEReference(getRESTfulServicePSM_HasJavaRModel(), this.getJavaResourceModel(), null, "hasJavaRModel", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasJavaRController(), this.getJavaResourceController(), null, "hasJavaRController", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasJavaRCManager(), this.getJavaResourceControllerManager(), null, "hasJavaRCManager", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasJavaRMManager(), this.getJavaResourceModelManager(), null, "hasJavaRMManager", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasJavaAlgoModel(), this.getJavaAlgoResourceModel(), null, "hasJavaAlgoModel", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasJavaAlgoController(), this.getJavaAlgoResourceController(), null, "hasJavaAlgoController", null, 0, -1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRESTfulServicePSM_HasHibernateController(), this.getHibernateController(), null, "hasHibernateController", null, 1, 1, RESTfulServicePSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (javaResourceControllerManagerEClass, 
		   source, 
		   new String[] {
			 "constraints", "controllerURIPathAnnotation RCManagerNotAllowedHTTPActivityVerbs RCManagerActivitiesHaveJAXRSAnnotations JRCManagerPostActivityAddsPostHypermediaLinkToSelf JRCManagerGetActivityAddsPostHypermediaLinkToSelf JRCManagerPostActivityAddsGetHypermediaLinkToSelf JRCManagerGetActivityAddsPostHypermediaLinkToSelf"
		   });	
		addAnnotation
