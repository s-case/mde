 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#getPropertyHasHibernateAnnotation <em>Property Has Hibernate Annotation</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#isBIsUnique <em>BIs Unique</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#isBIsNamingProperty <em>BIs Naming Property</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMComponentPropertyImpl#isBIsPrimaryIdentifier <em>BIs Primary Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PSMComponentPropertyImpl extends MinimalEObjectImpl.Container implements PSMComponentProperty {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.PSM_COMPONENT_PROPERTY;
	}
	...
	public EList<HibernateAnnotation> getPropertyHasHibernateAnnotation() {
		if (propertyHasHibernateAnnotation == null) {
			propertyHasHibernateAnnotation = new EObjectContainmentEList<HibernateAnnotation>(HibernateAnnotation.class, this, ServicePSMPackage.PSM_COMPONENT_PROPERTY__PROPERTY_HAS_HIBERNATE_ANNOTATION);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_COMPONENT_PROPERTY__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_COMPONENT_PROPERTY__TYPE, oldType, type));
	}
	...
	public void setBIsUnique(boolean newBIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_UNIQUE, oldBIsUnique, bIsUnique));
	}
	...
	public void setBIsNamingProperty(boolean newBIsNamingProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_NAMING_PROPERTY, oldBIsNamingProperty, bIsNamingProperty));
	}
	...
	public void setBIsPrimaryIdentifier(boolean newBIsPrimaryIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_PRIMARY_IDENTIFIER, oldBIsPrimaryIdentifier, bIsPrimaryIdentifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__PROPERTY_HAS_HIBERNATE_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__NAME:
				return getName();
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__TYPE:
				return getType();
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_UNIQUE:
				return isBIsUnique();
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_NAMING_PROPERTY:
				return isBIsNamingProperty();
			case ServicePSMPackage.PSM_COMPONENT_PROPERTY__BIS_PRIMARY_IDENTIFIER:
