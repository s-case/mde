...
public class JavaResourceControllerManagerImpl extends MinimalEObjectImpl.Container implements JavaResourceControllerManager {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_RESOURCE_CONTROLLER_MANAGER;
	}
	...
	public NotificationChain basicSetJavaRCManagerHasJAXRSAnnotation(JAXRSAnnotation newJavaRCManagerHasJAXRSAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_JAXRS_ANNOTATION, oldJavaRCManagerHasJAXRSAnnotation, newJavaRCManagerHasJAXRSAnnotation);
	...
	public void setJavaRCManagerHasJAXRSAnnotation(JAXRSAnnotation newJavaRCManagerHasJAXRSAnnotation) {
		if (newJavaRCManagerHasJAXRSAnnotation != javaRCManagerHasJAXRSAnnotation) {
			...
			if (javaRCManagerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)javaRCManagerHasJAXRSAnnotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_JAXRS_ANNOTATION, null, msgs);
			if (newJavaRCManagerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)newJavaRCManagerHasJAXRSAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_JAXRS_ANNOTATION, null, msgs);
			msgs = basicSetJavaRCManagerHasJAXRSAnnotation(newJavaRCManagerHasJAXRSAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_JAXRS_ANNOTATION, newJavaRCManagerHasJAXRSAnnotation, newJavaRCManagerHasJAXRSAnnotation));
	}
	...
	public EList<HTTPActivity> getJavaRCManagerHasHTTPActivity() {
		if (javaRCManagerHasHTTPActivity == null) {
			javaRCManagerHasHTTPActivity = new EObjectContainmentEList<HTTPActivity>(HTTPActivity.class, this, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_HTTP_ACTIVITY);
		}
	...
	public JavaResourceModelManager getHasAssociatedRMManager() {
		if (hasAssociatedRMManager != null && hasAssociatedRMManager.eIsProxy()) {
			...
			if (hasAssociatedRMManager != oldHasAssociatedRMManager) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__HAS_ASSOCIATED_RM_MANAGER, oldHasAssociatedRMManager, hasAssociatedRMManager));
			}
		}
	...
	public void setHasAssociatedRMManager(JavaResourceModelManager newHasAssociatedRMManager) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__HAS_ASSOCIATED_RM_MANAGER, oldHasAssociatedRMManager, hasAssociatedRMManager));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__NAME, oldName, name));
	}
	...
	public void setControllerURI(String newControllerURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__CONTROLLER_URI, oldControllerURI, controllerURI));
	}
	...
	public void setParentName(String newParentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__PARENT_NAME, oldParentName, parentName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_JAXRS_ANNOTATION:
				return basicSetJavaRCManagerHasJAXRSAnnotation(null, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__JAVA_RC_MANAGER_HAS_HTTP_ACTIVITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__HAS_ASSOCIATED_RM_MANAGER:
				if (resolve) return getHasAssociatedRMManager();
				return basicGetHasAssociatedRMManager();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__NAME:
				return getName();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__CONTROLLER_URI:
				return getControllerURI();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER_MANAGER__PARENT_NAME:
