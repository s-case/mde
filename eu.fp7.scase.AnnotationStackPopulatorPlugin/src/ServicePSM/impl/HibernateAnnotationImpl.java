 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HibernateAnnotationImpl#getHibernateAnnotationText <em>Hibernate Annotation Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HibernateAnnotationImpl extends MinimalEObjectImpl.Container implements HibernateAnnotation {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HIBERNATE_ANNOTATION;
	}
	...
	public void setHibernateAnnotationText(String newHibernateAnnotationText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HIBERNATE_ANNOTATION__HIBERNATE_ANNOTATION_TEXT, oldHibernateAnnotationText, hibernateAnnotationText));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.HIBERNATE_ANNOTATION__HIBERNATE_ANNOTATION_TEXT:
