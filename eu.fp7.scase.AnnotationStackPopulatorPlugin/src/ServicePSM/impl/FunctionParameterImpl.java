...
public class FunctionParameterImpl extends MinimalEObjectImpl.Container implements FunctionParameter {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.FUNCTION_PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.FUNCTION_PARAMETER__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.FUNCTION_PARAMETER__TYPE, oldType, type));
	}
	...
	public void setBIsUnique(boolean newBIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.FUNCTION_PARAMETER__BIS_UNIQUE, oldBIsUnique, bIsUnique));
	}
	...
	public void setBIsReturnParameter(boolean newBIsReturnParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.FUNCTION_PARAMETER__BIS_RETURN_PARAMETER, oldBIsReturnParameter, bIsReturnParameter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.FUNCTION_PARAMETER__NAME:
				return getName();
			case ServicePSMPackage.FUNCTION_PARAMETER__TYPE:
				return getType();
			case ServicePSMPackage.FUNCTION_PARAMETER__BIS_UNIQUE:
				return isBIsUnique();
			case ServicePSMPackage.FUNCTION_PARAMETER__BIS_RETURN_PARAMETER:
