...
public class RESTfulServicePSMImpl extends MinimalEObjectImpl.Container implements RESTfulServicePSM {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.RES_TFUL_SERVICE_PSM;
	}
	...
	public EList<JavaResourceModel> getHasJavaRModel() {
		if (hasJavaRModel == null) {
			hasJavaRModel = new EObjectContainmentEList<JavaResourceModel>(JavaResourceModel.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RMODEL);
		}
	...
	public EList<JavaResourceController> getHasJavaRController() {
		if (hasJavaRController == null) {
			hasJavaRController = new EObjectContainmentEList<JavaResourceController>(JavaResourceController.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RCONTROLLER);
		}
	...
	public EList<JavaResourceControllerManager> getHasJavaRCManager() {
		if (hasJavaRCManager == null) {
			hasJavaRCManager = new EObjectContainmentEList<JavaResourceControllerManager>(JavaResourceControllerManager.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RC_MANAGER);
		}
	...
	public EList<JavaResourceModelManager> getHasJavaRMManager() {
		if (hasJavaRMManager == null) {
			hasJavaRMManager = new EObjectContainmentEList<JavaResourceModelManager>(JavaResourceModelManager.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RM_MANAGER);
		}
	...
	public EList<JavaAlgoResourceModel> getHasJavaAlgoModel() {
		if (hasJavaAlgoModel == null) {
			hasJavaAlgoModel = new EObjectContainmentEList<JavaAlgoResourceModel>(JavaAlgoResourceModel.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_MODEL);
		}
	...
	public EList<JavaAlgoResourceController> getHasJavaAlgoController() {
		if (hasJavaAlgoController == null) {
			hasJavaAlgoController = new EObjectContainmentEList<JavaAlgoResourceController>(JavaAlgoResourceController.class, this, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_CONTROLLER);
		}
	...
	public NotificationChain basicSetHasHibernateController(HibernateController newHasHibernateController, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER, oldHasHibernateController, newHasHibernateController);
	...
	public void setHasHibernateController(HibernateController newHasHibernateController) {
		if (newHasHibernateController != hasHibernateController) {
			...
			if (hasHibernateController != null)
				msgs = ((InternalEObject)hasHibernateController).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER, null, msgs);
			if (newHasHibernateController != null)
				msgs = ((InternalEObject)newHasHibernateController).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER, null, msgs);
			msgs = basicSetHasHibernateController(newHasHibernateController, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER, newHasHibernateController, newHasHibernateController));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__NAME, oldName, name));
	}
	...
	public void setServiceOutputPath(String newServiceOutputPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_OUTPUT_PATH, oldServiceOutputPath, serviceOutputPath));
	}
	...
	public void setServiceDatabaseIP(String newServiceDatabaseIP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_IP, oldServiceDatabaseIP, serviceDatabaseIP));
	}
	...
	public void setServiceDatabasePort(String newServiceDatabasePort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_PORT, oldServiceDatabasePort, serviceDatabasePort));
	}
	...
	public void setServiceDatabaseUsername(String newServiceDatabaseUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_USERNAME, oldServiceDatabaseUsername, serviceDatabaseUsername));
	}
	...
	public void setServiceDatabasePassword(String newServiceDatabasePassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_PASSWORD, oldServiceDatabasePassword, serviceDatabasePassword));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RMODEL:
				return ((InternalEList<?>)getHasJavaRModel()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RCONTROLLER:
				return ((InternalEList<?>)getHasJavaRController()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RC_MANAGER:
				return ((InternalEList<?>)getHasJavaRCManager()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_RM_MANAGER:
				return ((InternalEList<?>)getHasJavaRMManager()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_MODEL:
				return ((InternalEList<?>)getHasJavaAlgoModel()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_JAVA_ALGO_CONTROLLER:
				return ((InternalEList<?>)getHasJavaAlgoController()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__HAS_HIBERNATE_CONTROLLER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__NAME:
				return getName();
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_OUTPUT_PATH:
				return getServiceOutputPath();
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_IP:
				return getServiceDatabaseIP();
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_PORT:
				return getServiceDatabasePort();
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_USERNAME:
				return getServiceDatabaseUsername();
			case ServicePSMPackage.RES_TFUL_SERVICE_PSM__SERVICE_DATABASE_PASSWORD:
