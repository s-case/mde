 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getJavaRControllerHasJAXRSAnnotation <em>Java RController Has JAXRS Annotation</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getJavaRControllerHasHTTPActivity <em>Java RController Has HTTP Activity</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getHasAssociatedJavaRModel <em>Has Associated Java RModel</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getControllerURI <em>Controller URI</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceControllerImpl#getParentName <em>Parent Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaResourceControllerImpl extends MinimalEObjectImpl.Container implements JavaResourceController {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_RESOURCE_CONTROLLER;
	}
	...
	public NotificationChain basicSetJavaRControllerHasJAXRSAnnotation(JAXRSAnnotation newJavaRControllerHasJAXRSAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_JAXRS_ANNOTATION, oldJavaRControllerHasJAXRSAnnotation, newJavaRControllerHasJAXRSAnnotation);
	...
	public void setJavaRControllerHasJAXRSAnnotation(JAXRSAnnotation newJavaRControllerHasJAXRSAnnotation) {
		if (newJavaRControllerHasJAXRSAnnotation != javaRControllerHasJAXRSAnnotation) {
			...
			if (javaRControllerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)javaRControllerHasJAXRSAnnotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_JAXRS_ANNOTATION, null, msgs);
			if (newJavaRControllerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)newJavaRControllerHasJAXRSAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_JAXRS_ANNOTATION, null, msgs);
			msgs = basicSetJavaRControllerHasJAXRSAnnotation(newJavaRControllerHasJAXRSAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_JAXRS_ANNOTATION, newJavaRControllerHasJAXRSAnnotation, newJavaRControllerHasJAXRSAnnotation));
	}
	...
	public EList<HTTPActivity> getJavaRControllerHasHTTPActivity() {
		if (javaRControllerHasHTTPActivity == null) {
			javaRControllerHasHTTPActivity = new EObjectContainmentEList<HTTPActivity>(HTTPActivity.class, this, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_HTTP_ACTIVITY);
		}
	...
	public JavaResourceModel getHasAssociatedJavaRModel() {
		if (hasAssociatedJavaRModel != null && hasAssociatedJavaRModel.eIsProxy()) {
			...
			if (hasAssociatedJavaRModel != oldHasAssociatedJavaRModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__HAS_ASSOCIATED_JAVA_RMODEL, oldHasAssociatedJavaRModel, hasAssociatedJavaRModel));
			}
		}
	...
	public void setHasAssociatedJavaRModel(JavaResourceModel newHasAssociatedJavaRModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__HAS_ASSOCIATED_JAVA_RMODEL, oldHasAssociatedJavaRModel, hasAssociatedJavaRModel));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__NAME, oldName, name));
	}
	...
	public void setControllerURI(String newControllerURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__CONTROLLER_URI, oldControllerURI, controllerURI));
	}
	...
	public void setParentName(String newParentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__PARENT_NAME, oldParentName, parentName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_JAXRS_ANNOTATION:
				return basicSetJavaRControllerHasJAXRSAnnotation(null, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__JAVA_RCONTROLLER_HAS_HTTP_ACTIVITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__HAS_ASSOCIATED_JAVA_RMODEL:
				if (resolve) return getHasAssociatedJavaRModel();
				return basicGetHasAssociatedJavaRModel();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__NAME:
				return getName();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__CONTROLLER_URI:
				return getControllerURI();
			case ServicePSMPackage.JAVA_RESOURCE_CONTROLLER__PARENT_NAME:
