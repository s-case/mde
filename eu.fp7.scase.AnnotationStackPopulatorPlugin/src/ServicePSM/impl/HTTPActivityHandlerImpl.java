 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HTTPActivityHandlerImpl#getHasHypermediaFunction <em>Has Hypermedia Function</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityHandlerImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityHandlerImpl#getHandlerHTTPVerb <em>Handler HTTP Verb</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HTTPActivityHandlerImpl extends MinimalEObjectImpl.Container implements HTTPActivityHandler {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HTTP_ACTIVITY_HANDLER;
	}
	...
	public NotificationChain basicSetHasHypermediaFunction(JavaHypermediaFunction newHasHypermediaFunction, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HAS_HYPERMEDIA_FUNCTION, oldHasHypermediaFunction, newHasHypermediaFunction);
	...
	public void setHasHypermediaFunction(JavaHypermediaFunction newHasHypermediaFunction) {
		if (newHasHypermediaFunction != hasHypermediaFunction) {
			...
			if (hasHypermediaFunction != null)
				msgs = ((InternalEObject)hasHypermediaFunction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HAS_HYPERMEDIA_FUNCTION, null, msgs);
			if (newHasHypermediaFunction != null)
				msgs = ((InternalEObject)newHasHypermediaFunction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HAS_HYPERMEDIA_FUNCTION, null, msgs);
			msgs = basicSetHasHypermediaFunction(newHasHypermediaFunction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HAS_HYPERMEDIA_FUNCTION, newHasHypermediaFunction, newHasHypermediaFunction));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_HANDLER__NAME, oldName, name));
	}
	...
	public void setHandlerHTTPVerb(HTTPVerb newHandlerHTTPVerb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HANDLER_HTTP_VERB, oldHandlerHTTPVerb, handlerHTTPVerb));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HAS_HYPERMEDIA_FUNCTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.HTTP_ACTIVITY_HANDLER__NAME:
				return getName();
			case ServicePSMPackage.HTTP_ACTIVITY_HANDLER__HANDLER_HTTP_VERB:
