 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HibernateActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.HibernateActivityImpl#getHibernateActivityHTTPVerb <em>Hibernate Activity HTTP Verb</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HibernateActivityImpl extends MinimalEObjectImpl.Container implements HibernateActivity {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HIBERNATE_ACTIVITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HIBERNATE_ACTIVITY__NAME, oldName, name));
	}
	...
	public void setHibernateActivityHTTPVerb(HTTPVerb newHibernateActivityHTTPVerb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HIBERNATE_ACTIVITY__HIBERNATE_ACTIVITY_HTTP_VERB, oldHibernateActivityHTTPVerb, hibernateActivityHTTPVerb));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.HIBERNATE_ACTIVITY__NAME:
				return getName();
			case ServicePSMPackage.HIBERNATE_ACTIVITY__HIBERNATE_ACTIVITY_HTTP_VERB:
