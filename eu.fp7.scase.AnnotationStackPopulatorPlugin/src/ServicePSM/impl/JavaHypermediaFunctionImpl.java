...
public class JavaHypermediaFunctionImpl extends MinimalEObjectImpl.Container implements JavaHypermediaFunction {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_HYPERMEDIA_FUNCTION;
	}
	...
	public EList<PSMHypermediaLink> getHasPSMHypermediaLink() {
		if (hasPSMHypermediaLink == null) {
			hasPSMHypermediaLink = new EObjectContainmentEList<PSMHypermediaLink>(PSMHypermediaLink.class, this, ServicePSMPackage.JAVA_HYPERMEDIA_FUNCTION__HAS_PSM_HYPERMEDIA_LINK);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_HYPERMEDIA_FUNCTION__HAS_PSM_HYPERMEDIA_LINK:
