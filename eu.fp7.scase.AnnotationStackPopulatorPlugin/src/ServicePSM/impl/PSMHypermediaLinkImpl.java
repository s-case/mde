 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.PSMHypermediaLinkImpl#getHasTargetJavaAlgoController <em>Has Target Java Algo Controller</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMHypermediaLinkImpl#getHasTargetJavaRController <em>Has Target Java RController</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMHypermediaLinkImpl#getHasTargetRCManager <em>Has Target RC Manager</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMHypermediaLinkImpl#getLinkHTTPVerb <em>Link HTTP Verb</em>}</li>
 *   <li>{@link ServicePSM.impl.PSMHypermediaLinkImpl#getLinkType <em>Link Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PSMHypermediaLinkImpl extends MinimalEObjectImpl.Container implements PSMHypermediaLink {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.PSM_HYPERMEDIA_LINK;
	}
		...
		if (hasTargetJavaAlgoController != null && hasTargetJavaAlgoController.eIsProxy()) {
			...
			if (hasTargetJavaAlgoController != oldHasTargetJavaAlgoController) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_ALGO_CONTROLLER, oldHasTargetJavaAlgoController, hasTargetJavaAlgoController));
			}
		}
	...
	public void setHasTargetJavaAlgoController(JavaAlgoResourceController newHasTargetJavaAlgoController) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_ALGO_CONTROLLER, oldHasTargetJavaAlgoController, hasTargetJavaAlgoController));
	}
	...
	public JavaResourceController getHasTargetJavaRController() {
		if (hasTargetJavaRController != null && hasTargetJavaRController.eIsProxy()) {
			...
			if (hasTargetJavaRController != oldHasTargetJavaRController) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_RCONTROLLER, oldHasTargetJavaRController, hasTargetJavaRController));
			}
		}
	...
	public void setHasTargetJavaRController(JavaResourceController newHasTargetJavaRController) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_RCONTROLLER, oldHasTargetJavaRController, hasTargetJavaRController));
	}
	...
	public JavaResourceControllerManager getHasTargetRCManager() {
		if (hasTargetRCManager != null && hasTargetRCManager.eIsProxy()) {
			...
			if (hasTargetRCManager != oldHasTargetRCManager) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_RC_MANAGER, oldHasTargetRCManager, hasTargetRCManager));
			}
		}
	...
	public void setHasTargetRCManager(JavaResourceControllerManager newHasTargetRCManager) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_RC_MANAGER, oldHasTargetRCManager, hasTargetRCManager));
	}
	...
	public void setLinkHTTPVerb(HTTPVerb newLinkHTTPVerb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_HYPERMEDIA_LINK__LINK_HTTP_VERB, oldLinkHTTPVerb, linkHTTPVerb));
	}
	...
	public void setLinkType(LinkType newLinkType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.PSM_HYPERMEDIA_LINK__LINK_TYPE, oldLinkType, linkType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_ALGO_CONTROLLER:
				if (resolve) return getHasTargetJavaAlgoController();
				return basicGetHasTargetJavaAlgoController();
			case ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_JAVA_RCONTROLLER:
				if (resolve) return getHasTargetJavaRController();
				return basicGetHasTargetJavaRController();
			case ServicePSMPackage.PSM_HYPERMEDIA_LINK__HAS_TARGET_RC_MANAGER:
				if (resolve) return getHasTargetRCManager();
				return basicGetHasTargetRCManager();
			case ServicePSMPackage.PSM_HYPERMEDIA_LINK__LINK_HTTP_VERB:
				return getLinkHTTPVerb();
			case ServicePSMPackage.PSM_HYPERMEDIA_LINK__LINK_TYPE:
				return getLinkType();
		}
