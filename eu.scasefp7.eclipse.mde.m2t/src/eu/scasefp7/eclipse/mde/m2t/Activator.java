package eu.scasefp7.eclipse.mde.m2t;
...
public class Activator extends Plugin {
	...
	/** The plug-in ID */
	public static final String PLUGIN_ID = "eu.scasefp7.eclipse.mde.m2t"; //$NON-NLS-1$
	...
	public static void log(String className, String methodName, String message, Exception exception) {
		String msg = message;
		msg += "\n!ERROR_ID t" + errorID;
		msg += "\n!SERVICE_NAME MDE Model to Text transformations plugin";
