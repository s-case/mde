...
/* JavaAlgobookmarkSearchModel class is responsible to model any data the bookmarkSearch resource handles. Since this one 
 is not automatable, the developer has to manually define it by providing its properties and setter/getter functions.*/
@XmlRootElement
public class JavaAlgobookmarkSearchModel{

    /* There follows a list with the properties that model the bookmarkSearch resource, as prescribed in the service CIM*/
