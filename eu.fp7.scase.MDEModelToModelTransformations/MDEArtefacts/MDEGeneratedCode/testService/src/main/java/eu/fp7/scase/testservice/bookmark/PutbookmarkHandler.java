...
/* This class processes PUT requests for bookmark resources and creates the hypermedia to be returned to the client*/

public class PutbookmarkHandler{
    ...
    public PutbookmarkHandler(String authHeader, int accountId, int bookmarkId, JavabookmarkModel oJavabookmarkModel, UriInfo oApplicationUri){
        this.oJavabookmarkModel = oJavabookmarkModel;
        this.oJavabookmarkModel.setbookmarkId(bookmarkId);
    ...
    public JavabookmarkModel putJavabookmarkModel(){
        ...
        return createHypermedia(oHibernateController.putbookmark(oJavabookmarkModel));
    }
