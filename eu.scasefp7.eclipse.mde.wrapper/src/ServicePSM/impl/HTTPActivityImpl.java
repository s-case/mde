 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getIsMappedToHibernateActivity <em>Is Mapped To Hibernate Activity</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getHasHTTPActivityParameter <em>Has HTTP Activity Parameter</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getActivityHTTPVerb <em>Activity HTTP Verb</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getHTTPActivityURI <em>HTTP Activity URI</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getHasHTTPActivityHandler <em>Has HTTP Activity Handler</em>}</li>
 *   <li>{@link ServicePSM.impl.HTTPActivityImpl#getHTTPActivityHasJAXRSAnnotation <em>HTTP Activity Has JAXRS Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HTTPActivityImpl extends MinimalEObjectImpl.Container implements HTTPActivity {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HTTP_ACTIVITY;
	}
		...
		if (isMappedToHibernateActivity != null && isMappedToHibernateActivity.eIsProxy()) {
			...
			if (isMappedToHibernateActivity != oldIsMappedToHibernateActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.HTTP_ACTIVITY__IS_MAPPED_TO_HIBERNATE_ACTIVITY, oldIsMappedToHibernateActivity, isMappedToHibernateActivity));
			}
		}
	...
	public void setIsMappedToHibernateActivity(HibernateActivity newIsMappedToHibernateActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__IS_MAPPED_TO_HIBERNATE_ACTIVITY, oldIsMappedToHibernateActivity, isMappedToHibernateActivity));
	}
	...
	public EList<HTTPActivityFunctionParameter> getHasHTTPActivityParameter() {
		if (hasHTTPActivityParameter == null) {
			hasHTTPActivityParameter = new EObjectContainmentEList<HTTPActivityFunctionParameter>(HTTPActivityFunctionParameter.class, this, ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_PARAMETER);
		}
	...
	public void setActivityHTTPVerb(HTTPVerb newActivityHTTPVerb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__ACTIVITY_HTTP_VERB, oldActivityHTTPVerb, activityHTTPVerb));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__NAME, oldName, name));
	}
	...
	public void setHTTPActivityURI(String newHTTPActivityURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__HTTP_ACTIVITY_URI, oldHTTPActivityURI, httpActivityURI));
	}
	...
	public NotificationChain basicSetHasHTTPActivityHandler(HTTPActivityHandler newHasHTTPActivityHandler, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_HANDLER, oldHasHTTPActivityHandler, newHasHTTPActivityHandler);
	...
	public void setHasHTTPActivityHandler(HTTPActivityHandler newHasHTTPActivityHandler) {
		if (newHasHTTPActivityHandler != hasHTTPActivityHandler) {
			...
			if (hasHTTPActivityHandler != null)
				msgs = ((InternalEObject)hasHTTPActivityHandler).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_HANDLER, null, msgs);
			if (newHasHTTPActivityHandler != null)
				msgs = ((InternalEObject)newHasHTTPActivityHandler).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_HANDLER, null, msgs);
			msgs = basicSetHasHTTPActivityHandler(newHasHTTPActivityHandler, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_HANDLER, newHasHTTPActivityHandler, newHasHTTPActivityHandler));
	}
	...
	public EList<JAXRSAnnotation> getHTTPActivityHasJAXRSAnnotation() {
		if (httpActivityHasJAXRSAnnotation == null) {
			httpActivityHasJAXRSAnnotation = new EObjectContainmentEList<JAXRSAnnotation>(JAXRSAnnotation.class, this, ServicePSMPackage.HTTP_ACTIVITY__HTTP_ACTIVITY_HAS_JAXRS_ANNOTATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_PARAMETER:
				return ((InternalEList<?>)getHasHTTPActivityParameter()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.HTTP_ACTIVITY__HAS_HTTP_ACTIVITY_HANDLER:
				return basicSetHasHTTPActivityHandler(null, msgs);
			case ServicePSMPackage.HTTP_ACTIVITY__HTTP_ACTIVITY_HAS_JAXRS_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.HTTP_ACTIVITY__IS_MAPPED_TO_HIBERNATE_ACTIVITY:
			...
			case ServicePSMPackage.HTTP_ACTIVITY__ACTIVITY_HTTP_VERB:
				return getActivityHTTPVerb();
			case ServicePSMPackage.HTTP_ACTIVITY__NAME:
				return getName();
			case ServicePSMPackage.HTTP_ACTIVITY__HTTP_ACTIVITY_URI:
