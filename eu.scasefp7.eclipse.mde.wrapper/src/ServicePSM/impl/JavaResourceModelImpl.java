 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getJavaRModelHasJAXBAnnotation <em>Java RModel Has JAXB Annotation</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getJavaRModelHasProperty <em>Java RModel Has Property</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getHasRelatedJavaRMManager <em>Has Related Java RM Manager</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getJavaRModelHasHibernateAnnotation <em>Java RModel Has Hibernate Annotation</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getJavaRModelHasSetter <em>Java RModel Has Setter</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getJavaRModelHasGetter <em>Java RModel Has Getter</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getHasRelatedJavaAlgoModel <em>Has Related Java Algo Model</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaResourceModelImpl#getParentName <em>Parent Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaResourceModelImpl extends MinimalEObjectImpl.Container implements JavaResourceModel {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_RESOURCE_MODEL;
	}
	...
	public NotificationChain basicSetJavaRModelHasJAXBAnnotation(JAXBAnnotation newJavaRModelHasJAXBAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_JAXB_ANNOTATION, oldJavaRModelHasJAXBAnnotation, newJavaRModelHasJAXBAnnotation);
	...
	public void setJavaRModelHasJAXBAnnotation(JAXBAnnotation newJavaRModelHasJAXBAnnotation) {
		if (newJavaRModelHasJAXBAnnotation != javaRModelHasJAXBAnnotation) {
			...
			if (javaRModelHasJAXBAnnotation != null)
				msgs = ((InternalEObject)javaRModelHasJAXBAnnotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_JAXB_ANNOTATION, null, msgs);
			if (newJavaRModelHasJAXBAnnotation != null)
				msgs = ((InternalEObject)newJavaRModelHasJAXBAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_JAXB_ANNOTATION, null, msgs);
			msgs = basicSetJavaRModelHasJAXBAnnotation(newJavaRModelHasJAXBAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_JAXB_ANNOTATION, newJavaRModelHasJAXBAnnotation, newJavaRModelHasJAXBAnnotation));
	}
	...
	public EList<PSMComponentProperty> getJavaRModelHasProperty() {
		if (javaRModelHasProperty == null) {
			javaRModelHasProperty = new EObjectContainmentEList<PSMComponentProperty>(PSMComponentProperty.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_PROPERTY);
		}
	...
	public EList<JavaResourceModelManager> getHasRelatedJavaRMManager() {
		if (hasRelatedJavaRMManager == null) {
			hasRelatedJavaRMManager = new EObjectResolvingEList<JavaResourceModelManager>(JavaResourceModelManager.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__HAS_RELATED_JAVA_RM_MANAGER);
		}
	...
	public EList<HibernateAnnotation> getJavaRModelHasHibernateAnnotation() {
		if (javaRModelHasHibernateAnnotation == null) {
			javaRModelHasHibernateAnnotation = new EObjectContainmentEList<HibernateAnnotation>(HibernateAnnotation.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_HIBERNATE_ANNOTATION);
		}
	...
	public EList<JavaSetterFunction> getJavaRModelHasSetter() {
		if (javaRModelHasSetter == null) {
			javaRModelHasSetter = new EObjectContainmentEList<JavaSetterFunction>(JavaSetterFunction.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_SETTER);
		}
	...
	public EList<JavaGetterFunction> getJavaRModelHasGetter() {
		if (javaRModelHasGetter == null) {
			javaRModelHasGetter = new EObjectContainmentEList<JavaGetterFunction>(JavaGetterFunction.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_GETTER);
		}
	...
	public EList<JavaAlgoResourceModel> getHasRelatedJavaAlgoModel() {
		if (hasRelatedJavaAlgoModel == null) {
			hasRelatedJavaAlgoModel = new EObjectResolvingEList<JavaAlgoResourceModel>(JavaAlgoResourceModel.class, this, ServicePSMPackage.JAVA_RESOURCE_MODEL__HAS_RELATED_JAVA_ALGO_MODEL);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_MODEL__NAME, oldName, name));
	}
	...
	public void setParentName(String newParentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_RESOURCE_MODEL__PARENT_NAME, oldParentName, parentName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_JAXB_ANNOTATION:
				return basicSetJavaRModelHasJAXBAnnotation(null, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_PROPERTY:
				return ((InternalEList<?>)getJavaRModelHasProperty()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_HIBERNATE_ANNOTATION:
				return ((InternalEList<?>)getJavaRModelHasHibernateAnnotation()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_SETTER:
				return ((InternalEList<?>)getJavaRModelHasSetter()).basicRemove(otherEnd, msgs);
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__JAVA_RMODEL_HAS_GETTER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__HAS_RELATED_JAVA_RM_MANAGER:
			...
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__HAS_RELATED_JAVA_ALGO_MODEL:
				return getHasRelatedJavaAlgoModel();
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__NAME:
				return getName();
			case ServicePSMPackage.JAVA_RESOURCE_MODEL__PARENT_NAME:
