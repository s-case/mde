 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.JavaFunctionImpl#getHasFunctionParameter <em>Has Function Parameter</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaFunctionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaFunctionImpl extends MinimalEObjectImpl.Container implements JavaFunction {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_FUNCTION;
	}
	...
	public EList<FunctionParameter> getHasFunctionParameter() {
		if (hasFunctionParameter == null) {
			hasFunctionParameter = new EObjectContainmentEList<FunctionParameter>(FunctionParameter.class, this, ServicePSMPackage.JAVA_FUNCTION__HAS_FUNCTION_PARAMETER);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_FUNCTION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_FUNCTION__HAS_FUNCTION_PARAMETER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.JAVA_FUNCTION__NAME:
				return getName();
		}
