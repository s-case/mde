 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HibernateControllerImpl#getHasHibernateActivity <em>Has Hibernate Activity</em>}</li>
 *   <li>{@link ServicePSM.impl.HibernateControllerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HibernateControllerImpl extends MinimalEObjectImpl.Container implements HibernateController {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HIBERNATE_CONTROLLER;
	}
	...
	public EList<HibernateActivity> getHasHibernateActivity() {
		if (hasHibernateActivity == null) {
			hasHibernateActivity = new EObjectContainmentEList<HibernateActivity>(HibernateActivity.class, this, ServicePSMPackage.HIBERNATE_CONTROLLER__HAS_HIBERNATE_ACTIVITY);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HIBERNATE_CONTROLLER__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.HIBERNATE_CONTROLLER__HAS_HIBERNATE_ACTIVITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ServicePSMPackage.HIBERNATE_CONTROLLER__NAME:
				return getName();
		}
