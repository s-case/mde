 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.HTTPActivityFunctionParameterImpl#getHTTPFunctionParameterHasJAXRSAnnotation <em>HTTP Function Parameter Has JAXRS Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HTTPActivityFunctionParameterImpl extends FunctionParameterImpl implements HTTPActivityFunctionParameter {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.HTTP_ACTIVITY_FUNCTION_PARAMETER;
	}
	...
	public NotificationChain basicSetHTTPFunctionParameterHasJAXRSAnnotation(JAXRSAnnotation newHTTPFunctionParameterHasJAXRSAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_FUNCTION_PARAMETER__HTTP_FUNCTION_PARAMETER_HAS_JAXRS_ANNOTATION, oldHTTPFunctionParameterHasJAXRSAnnotation, newHTTPFunctionParameterHasJAXRSAnnotation);
	...
	public void setHTTPFunctionParameterHasJAXRSAnnotation(JAXRSAnnotation newHTTPFunctionParameterHasJAXRSAnnotation) {
		if (newHTTPFunctionParameterHasJAXRSAnnotation != httpFunctionParameterHasJAXRSAnnotation) {
			...
			if (httpFunctionParameterHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)httpFunctionParameterHasJAXRSAnnotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY_FUNCTION_PARAMETER__HTTP_FUNCTION_PARAMETER_HAS_JAXRS_ANNOTATION, null, msgs);
			if (newHTTPFunctionParameterHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)newHTTPFunctionParameterHasJAXRSAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.HTTP_ACTIVITY_FUNCTION_PARAMETER__HTTP_FUNCTION_PARAMETER_HAS_JAXRS_ANNOTATION, null, msgs);
			msgs = basicSetHTTPFunctionParameterHasJAXRSAnnotation(newHTTPFunctionParameterHasJAXRSAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.HTTP_ACTIVITY_FUNCTION_PARAMETER__HTTP_FUNCTION_PARAMETER_HAS_JAXRS_ANNOTATION, newHTTPFunctionParameterHasJAXRSAnnotation, newHTTPFunctionParameterHasJAXRSAnnotation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.HTTP_ACTIVITY_FUNCTION_PARAMETER__HTTP_FUNCTION_PARAMETER_HAS_JAXRS_ANNOTATION:
