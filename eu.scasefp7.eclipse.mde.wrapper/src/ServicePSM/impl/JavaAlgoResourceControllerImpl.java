 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getHasAssociatedAlgoModel <em>Has Associated Algo Model</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getJavaAlgoRControllerHasHTTPActivity <em>Java Algo RController Has HTTP Activity</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getControllerURI <em>Controller URI</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getParentName <em>Parent Name</em>}</li>
 *   <li>{@link ServicePSM.impl.JavaAlgoResourceControllerImpl#getAlgoControllerHasJAXRSAnnotation <em>Algo Controller Has JAXRS Annotation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaAlgoResourceControllerImpl extends MinimalEObjectImpl.Container implements JavaAlgoResourceController {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_ALGO_RESOURCE_CONTROLLER;
	}
		...
		if (hasAssociatedAlgoModel != null && hasAssociatedAlgoModel.eIsProxy()) {
			...
			if (hasAssociatedAlgoModel != oldHasAssociatedAlgoModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__HAS_ASSOCIATED_ALGO_MODEL, oldHasAssociatedAlgoModel, hasAssociatedAlgoModel));
			}
		}
	...
	public void setHasAssociatedAlgoModel(JavaAlgoResourceModel newHasAssociatedAlgoModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__HAS_ASSOCIATED_ALGO_MODEL, oldHasAssociatedAlgoModel, hasAssociatedAlgoModel));
	}
	...
	public NotificationChain basicSetJavaAlgoRControllerHasHTTPActivity(HTTPActivity newJavaAlgoRControllerHasHTTPActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__JAVA_ALGO_RCONTROLLER_HAS_HTTP_ACTIVITY, oldJavaAlgoRControllerHasHTTPActivity, newJavaAlgoRControllerHasHTTPActivity);
	...
	public void setJavaAlgoRControllerHasHTTPActivity(HTTPActivity newJavaAlgoRControllerHasHTTPActivity) {
		if (newJavaAlgoRControllerHasHTTPActivity != javaAlgoRControllerHasHTTPActivity) {
			...
			if (javaAlgoRControllerHasHTTPActivity != null)
				msgs = ((InternalEObject)javaAlgoRControllerHasHTTPActivity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__JAVA_ALGO_RCONTROLLER_HAS_HTTP_ACTIVITY, null, msgs);
			if (newJavaAlgoRControllerHasHTTPActivity != null)
				msgs = ((InternalEObject)newJavaAlgoRControllerHasHTTPActivity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__JAVA_ALGO_RCONTROLLER_HAS_HTTP_ACTIVITY, null, msgs);
			msgs = basicSetJavaAlgoRControllerHasHTTPActivity(newJavaAlgoRControllerHasHTTPActivity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__JAVA_ALGO_RCONTROLLER_HAS_HTTP_ACTIVITY, newJavaAlgoRControllerHasHTTPActivity, newJavaAlgoRControllerHasHTTPActivity));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__NAME, oldName, name));
	}
	...
	public void setControllerURI(String newControllerURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__CONTROLLER_URI, oldControllerURI, controllerURI));
	}
	...
	public void setParentName(String newParentName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__PARENT_NAME, oldParentName, parentName));
	}
	...
	public NotificationChain basicSetAlgoControllerHasJAXRSAnnotation(JAXRSAnnotation newAlgoControllerHasJAXRSAnnotation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__ALGO_CONTROLLER_HAS_JAXRS_ANNOTATION, oldAlgoControllerHasJAXRSAnnotation, newAlgoControllerHasJAXRSAnnotation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlgoControllerHasJAXRSAnnotation(JAXRSAnnotation newAlgoControllerHasJAXRSAnnotation) {
		if (newAlgoControllerHasJAXRSAnnotation != algoControllerHasJAXRSAnnotation) {
			...
			if (algoControllerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)algoControllerHasJAXRSAnnotation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__ALGO_CONTROLLER_HAS_JAXRS_ANNOTATION, null, msgs);
			if (newAlgoControllerHasJAXRSAnnotation != null)
				msgs = ((InternalEObject)newAlgoControllerHasJAXRSAnnotation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__ALGO_CONTROLLER_HAS_JAXRS_ANNOTATION, null, msgs);
			msgs = basicSetAlgoControllerHasJAXRSAnnotation(newAlgoControllerHasJAXRSAnnotation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__ALGO_CONTROLLER_HAS_JAXRS_ANNOTATION, newAlgoControllerHasJAXRSAnnotation, newAlgoControllerHasJAXRSAnnotation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__JAVA_ALGO_RCONTROLLER_HAS_HTTP_ACTIVITY:
				return basicSetJavaAlgoRControllerHasHTTPActivity(null, msgs);
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__ALGO_CONTROLLER_HAS_JAXRS_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__HAS_ASSOCIATED_ALGO_MODEL:
			...
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__NAME:
				return getName();
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__CONTROLLER_URI:
				return getControllerURI();
			case ServicePSMPackage.JAVA_ALGO_RESOURCE_CONTROLLER__PARENT_NAME:
