 ...
 * <ul>
 *   <li>{@link ServicePSM.impl.JAXBAnnotationImpl#getJAXBAnnotationText <em>JAXB Annotation Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JAXBAnnotationImpl extends MinimalEObjectImpl.Container implements JAXBAnnotation {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAXB_ANNOTATION;
	}
	...
	public void setJAXBAnnotationText(String newJAXBAnnotationText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAXB_ANNOTATION__JAXB_ANNOTATION_TEXT, oldJAXBAnnotationText, jaxbAnnotationText));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.JAXB_ANNOTATION__JAXB_ANNOTATION_TEXT:
