...
public class JavaGetterFunctionImpl extends JavaFunctionImpl implements JavaGetterFunction {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAVA_GETTER_FUNCTION;
	}
		...
		if (getsProperty != null && getsProperty.eIsProxy()) {
			...
			if (getsProperty != oldGetsProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePSMPackage.JAVA_GETTER_FUNCTION__GETS_PROPERTY, oldGetsProperty, getsProperty));
			}
		}
		return getsProperty;
	}
	...
	public void setGetsProperty(PSMComponentProperty newGetsProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAVA_GETTER_FUNCTION__GETS_PROPERTY, oldGetsProperty, getsProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.JAVA_GETTER_FUNCTION__GETS_PROPERTY:
