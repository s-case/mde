...
public class JAXRSAnnotationImpl extends MinimalEObjectImpl.Container implements JAXRSAnnotation {
	...
	protected EClass eStaticClass() {
		return ServicePSMPackage.Literals.JAXRS_ANNOTATION;
	}
	...
	public void setJAXRSAnnotationText(String newJAXRSAnnotationText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePSMPackage.JAXRS_ANNOTATION__JAXRS_ANNOTATION_TEXT, oldJAXRSAnnotationText, jaxrsAnnotationText));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePSMPackage.JAXRS_ANNOTATION__JAXRS_ANNOTATION_TEXT:
