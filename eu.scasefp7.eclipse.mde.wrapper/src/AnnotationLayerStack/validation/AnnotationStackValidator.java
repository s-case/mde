...
public interface AnnotationStackValidator {
	...
	boolean validateHasAuthorizationLayer(AuthorizationLayerPSM.AnnotationModel value);
	boolean validateBHasAuthorizationLayer(boolean value);
	boolean validateHasDBMigrationLayer(MDEMigratorPSMMetamodel.AnnotationModel value);
	boolean validateBHasDBMigrationLayer(boolean value);
}
