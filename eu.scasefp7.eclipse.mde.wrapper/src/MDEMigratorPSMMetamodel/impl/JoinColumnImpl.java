 ...
 * </p>
 * <ul>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.JoinColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.JoinColumnImpl#getType <em>Type</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.JoinColumnImpl#getHasPkOrder <em>Has Pk Order</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.JoinColumnImpl#getHasFKOrder <em>Has FK Order</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinColumnImpl extends MinimalEObjectImpl.Container implements JoinColumn {
	...
	protected EClass eStaticClass() {
		return MDEMigratorPSMMetamodelPackage.Literals.JOIN_COLUMN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__TYPE, oldType, type));
	}
	...
	public void setHasPkOrder(int newHasPkOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__HAS_PK_ORDER, oldHasPkOrder, hasPkOrder));
	}
	...
	public void setHasFKOrder(int newHasFKOrder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__HAS_FK_ORDER, oldHasFKOrder, hasFKOrder));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__NAME:
				return getName();
			case MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__TYPE:
				return getType();
			case MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__HAS_PK_ORDER:
				return getHasPkOrder();
			case MDEMigratorPSMMetamodelPackage.JOIN_COLUMN__HAS_FK_ORDER:
