 ...
 * </p>
 * <ul>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getHasParentTargetRelation <em>Has Parent Target Relation</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getHasForeignKeyColumn <em>Has Foreign Key Column</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getSourceRelationFKMappingName <em>Source Relation FK Mapping Name</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getHasJoinFKToSourceRelation <em>Has Join FK To Source Relation</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getHasJoinFKToParentSourceRelation <em>Has Join FK To Parent Source Relation</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#isRequiresJoinTable <em>Requires Join Table</em>}</li>
 *   <li>{@link MDEMigratorPSMMetamodel.impl.ParentMappingImpl#getJoinTableName <em>Join Table Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParentMappingImpl extends MinimalEObjectImpl.Container implements ParentMapping {
	 ...
	 * @ordered
	 */
	protected static final String SOURCE_RELATION_FK_MAPPING_NAME_EDEFAULT = "";
	...
	protected EClass eStaticClass() {
		return MDEMigratorPSMMetamodelPackage.Literals.PARENT_MAPPING;
	}
		...
		if (hasParentTargetRelation != null && hasParentTargetRelation.eIsProxy()) {
			...
			if (hasParentTargetRelation != oldHasParentTargetRelation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_PARENT_TARGET_RELATION, oldHasParentTargetRelation, hasParentTargetRelation));
			}
		}
	...
	public void setHasParentTargetRelation(TargetRelation newHasParentTargetRelation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_PARENT_TARGET_RELATION, oldHasParentTargetRelation, hasParentTargetRelation));
	}
	...
	public EList<SourceColumn> getHasForeignKeyColumn() {
		if (hasForeignKeyColumn == null) {
			hasForeignKeyColumn = new EObjectResolvingEList<SourceColumn>(SourceColumn.class, this, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_FOREIGN_KEY_COLUMN);
		}
	...
	public void setSourceRelationFKMappingName(String newSourceRelationFKMappingName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__SOURCE_RELATION_FK_MAPPING_NAME, oldSourceRelationFKMappingName, sourceRelationFKMappingName));
	}
	...
	public EList<JoinColumn> getHasJoinFKToSourceRelation() {
		if (hasJoinFKToSourceRelation == null) {
			hasJoinFKToSourceRelation = new EObjectContainmentEList<JoinColumn>(JoinColumn.class, this, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_SOURCE_RELATION);
		}
	...
	public EList<JoinColumn> getHasJoinFKToParentSourceRelation() {
		if (hasJoinFKToParentSourceRelation == null) {
			hasJoinFKToParentSourceRelation = new EObjectContainmentEList<JoinColumn>(JoinColumn.class, this, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_PARENT_SOURCE_RELATION);
		}
	...
	public void setRequiresJoinTable(boolean newRequiresJoinTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__REQUIRES_JOIN_TABLE, oldRequiresJoinTable, requiresJoinTable));
	}
	...
	public void setJoinTableName(String newJoinTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__JOIN_TABLE_NAME, oldJoinTableName, joinTableName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_SOURCE_RELATION:
				return ((InternalEList<?>)getHasJoinFKToSourceRelation()).basicRemove(otherEnd, msgs);
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_PARENT_SOURCE_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_PARENT_TARGET_RELATION:
				if (resolve) return getHasParentTargetRelation();
				return basicGetHasParentTargetRelation();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_FOREIGN_KEY_COLUMN:
				return getHasForeignKeyColumn();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__SOURCE_RELATION_FK_MAPPING_NAME:
				return getSourceRelationFKMappingName();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_SOURCE_RELATION:
				return getHasJoinFKToSourceRelation();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__HAS_JOIN_FK_TO_PARENT_SOURCE_RELATION:
				return getHasJoinFKToParentSourceRelation();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__REQUIRES_JOIN_TABLE:
				return isRequiresJoinTable();
			case MDEMigratorPSMMetamodelPackage.PARENT_MAPPING__JOIN_TABLE_NAME:
