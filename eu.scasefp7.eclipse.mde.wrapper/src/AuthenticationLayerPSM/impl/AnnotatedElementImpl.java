 ...
 * <ul>
 *   <li>{@link AuthenticationLayerPSM.impl.AnnotatedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotatedElementImpl extends MinimalEObjectImpl.Container implements AnnotatedElement {
	...
	protected EClass eStaticClass() {
		return AuthenticationLayerPSMPackage.Literals.ANNOTATED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthenticationLayerPSMPackage.ANNOTATED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthenticationLayerPSMPackage.ANNOTATED_ELEMENT__NAME:
				return getName();
		}
