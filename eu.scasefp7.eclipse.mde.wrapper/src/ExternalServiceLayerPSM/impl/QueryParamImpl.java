...
public class QueryParamImpl extends MinimalEObjectImpl.Container implements QueryParam {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.QUERY_PARAM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.QUERY_PARAM__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.QUERY_PARAM__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.QUERY_PARAM__NAME:
				return getName();
