 ...
 * </p>
 * <ul>
 *   <li>{@link ExternalServiceLayerPSM.impl.AnnJavaResourceModelImpl#getAnnotatesJavaResourceModel <em>Annotates Java Resource Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnJavaResourceModelImpl extends AnnotatedElementImpl implements AnnJavaResourceModel {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.ANN_JAVA_RESOURCE_MODEL;
	}
		...
		if (annotatesJavaResourceModel != null && annotatesJavaResourceModel.eIsProxy()) {
			...
			if (annotatesJavaResourceModel != oldAnnotatesJavaResourceModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExternalServiceLayerPSMPackage.ANN_JAVA_RESOURCE_MODEL__ANNOTATES_JAVA_RESOURCE_MODEL, oldAnnotatesJavaResourceModel, annotatesJavaResourceModel));
			}
		}
	...
	public void setAnnotatesJavaResourceModel(JavaResourceModel newAnnotatesJavaResourceModel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.ANN_JAVA_RESOURCE_MODEL__ANNOTATES_JAVA_RESOURCE_MODEL, oldAnnotatesJavaResourceModel, annotatesJavaResourceModel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.ANN_JAVA_RESOURCE_MODEL__ANNOTATES_JAVA_RESOURCE_MODEL:
