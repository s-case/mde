...
public class AnnotationModelImpl extends MinimalEObjectImpl.Container implements AnnotationModel {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.ANNOTATION_MODEL;
	}
	...
	public EList<AnnotatedElement> getHasAnnotatedElement() {
		if (hasAnnotatedElement == null) {
			hasAnnotatedElement = new EObjectContainmentEList<AnnotatedElement>(AnnotatedElement.class, this, ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__HAS_ANNOTATED_ELEMENT);
		}
	...
	public EList<Annotation> getHasAnnotation() {
		if (hasAnnotation == null) {
			hasAnnotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__HAS_ANNOTATION);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__HAS_ANNOTATED_ELEMENT:
				return ((InternalEList<?>)getHasAnnotatedElement()).basicRemove(otherEnd, msgs);
			case ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__HAS_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ExternalServiceLayerPSMPackage.ANNOTATION_MODEL__NAME:
				return getName();
		}
