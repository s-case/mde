 ...
 * </p>
 * <ul>
 *   <li>{@link ExternalServiceLayerPSM.impl.AnnJavaAlgoControllerImpl#getAnnotatesJavaAlgoController <em>Annotates Java Algo Controller</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnJavaAlgoControllerImpl extends AnnotatedElementImpl implements AnnJavaAlgoController {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.ANN_JAVA_ALGO_CONTROLLER;
	}
		...
		if (annotatesJavaAlgoController != null && annotatesJavaAlgoController.eIsProxy()) {
			...
			if (annotatesJavaAlgoController != oldAnnotatesJavaAlgoController) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExternalServiceLayerPSMPackage.ANN_JAVA_ALGO_CONTROLLER__ANNOTATES_JAVA_ALGO_CONTROLLER, oldAnnotatesJavaAlgoController, annotatesJavaAlgoController));
			}
		}
	...
	public void setAnnotatesJavaAlgoController(JavaAlgoResourceController newAnnotatesJavaAlgoController) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.ANN_JAVA_ALGO_CONTROLLER__ANNOTATES_JAVA_ALGO_CONTROLLER, oldAnnotatesJavaAlgoController, annotatesJavaAlgoController));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.ANN_JAVA_ALGO_CONTROLLER__ANNOTATES_JAVA_ALGO_CONTROLLER:
