 ...
 * </p>
 * <ul>
 *   <li>{@link ExternalServiceLayerPSM.impl.AnnHTTPActivityImpl#getAnnotatesHTTPActivity <em>Annotates HTTP Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnHTTPActivityImpl extends AnnotatedElementImpl implements AnnHTTPActivity {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.ANN_HTTP_ACTIVITY;
	}
		...
		if (annotatesHTTPActivity != null && annotatesHTTPActivity.eIsProxy()) {
			...
			if (annotatesHTTPActivity != oldAnnotatesHTTPActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExternalServiceLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY, oldAnnotatesHTTPActivity, annotatesHTTPActivity));
			}
		}
	...
	public void setAnnotatesHTTPActivity(HTTPActivity newAnnotatesHTTPActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY, oldAnnotatesHTTPActivity, annotatesHTTPActivity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY:
