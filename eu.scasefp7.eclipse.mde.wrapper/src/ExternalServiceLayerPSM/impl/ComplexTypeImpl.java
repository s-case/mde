...
public class ComplexTypeImpl extends MinimalEObjectImpl.Container implements ComplexType {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.COMPLEX_TYPE;
	}
	...
	public void setComplexTypeName(String newComplexTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.COMPLEX_TYPE__COMPLEX_TYPE_NAME, oldComplexTypeName, complexTypeName));
	}
	...
	public EList<ComplexTypeProperty> getHasComplexTypeProperties() {
		if (hasComplexTypeProperties == null) {
			hasComplexTypeProperties = new EObjectContainmentEList<ComplexTypeProperty>(ComplexTypeProperty.class, this, ExternalServiceLayerPSMPackage.COMPLEX_TYPE__HAS_COMPLEX_TYPE_PROPERTIES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.COMPLEX_TYPE__HAS_COMPLEX_TYPE_PROPERTIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.COMPLEX_TYPE__COMPLEX_TYPE_NAME:
