 ...
 * </p>
 * <ul>
 *   <li>{@link ExternalServiceLayerPSM.impl.RepresentationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepresentationImpl extends MinimalEObjectImpl.Container implements Representation {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerPSMPackage.Literals.REPRESENTATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerPSMPackage.REPRESENTATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerPSMPackage.REPRESENTATION__NAME:
				return getName();
		}
