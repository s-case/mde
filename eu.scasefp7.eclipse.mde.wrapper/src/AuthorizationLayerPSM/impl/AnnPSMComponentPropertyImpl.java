 ...
 * </p>
 * <ul>
 *   <li>{@link AuthorizationLayerPSM.impl.AnnPSMComponentPropertyImpl#getAnnotatesPSMComponentProperty <em>Annotates PSM Component Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnPSMComponentPropertyImpl extends AnnotatedElementImpl implements AnnPSMComponentProperty {
	...
	protected EClass eStaticClass() {
		return AuthorizationLayerPSMPackage.Literals.ANN_PSM_COMPONENT_PROPERTY;
	}
		...
		if (annotatesPSMComponentProperty != null && annotatesPSMComponentProperty.eIsProxy()) {
			...
			if (annotatesPSMComponentProperty != oldAnnotatesPSMComponentProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AuthorizationLayerPSMPackage.ANN_PSM_COMPONENT_PROPERTY__ANNOTATES_PSM_COMPONENT_PROPERTY, oldAnnotatesPSMComponentProperty, annotatesPSMComponentProperty));
			}
		}
	...
	public void setAnnotatesPSMComponentProperty(PSMComponentProperty newAnnotatesPSMComponentProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorizationLayerPSMPackage.ANN_PSM_COMPONENT_PROPERTY__ANNOTATES_PSM_COMPONENT_PROPERTY, oldAnnotatesPSMComponentProperty, annotatesPSMComponentProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorizationLayerPSMPackage.ANN_PSM_COMPONENT_PROPERTY__ANNOTATES_PSM_COMPONENT_PROPERTY:
