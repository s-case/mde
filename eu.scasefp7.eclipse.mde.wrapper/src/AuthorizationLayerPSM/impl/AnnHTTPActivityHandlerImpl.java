 ...
 * </p>
 * <ul>
 *   <li>{@link AuthorizationLayerPSM.impl.AnnHTTPActivityHandlerImpl#getAnnotatesHTTPActivityHandler <em>Annotates HTTP Activity Handler</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnHTTPActivityHandlerImpl extends AnnotatedElementImpl implements AnnHTTPActivityHandler {
	...
	protected EClass eStaticClass() {
		return AuthorizationLayerPSMPackage.Literals.ANN_HTTP_ACTIVITY_HANDLER;
	}
		...
		if (annotatesHTTPActivityHandler != null && annotatesHTTPActivityHandler.eIsProxy()) {
			...
			if (annotatesHTTPActivityHandler != oldAnnotatesHTTPActivityHandler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AuthorizationLayerPSMPackage.ANN_HTTP_ACTIVITY_HANDLER__ANNOTATES_HTTP_ACTIVITY_HANDLER, oldAnnotatesHTTPActivityHandler, annotatesHTTPActivityHandler));
			}
		}
	...
	public void setAnnotatesHTTPActivityHandler(HTTPActivityHandler newAnnotatesHTTPActivityHandler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorizationLayerPSMPackage.ANN_HTTP_ACTIVITY_HANDLER__ANNOTATES_HTTP_ACTIVITY_HANDLER, oldAnnotatesHTTPActivityHandler, annotatesHTTPActivityHandler));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorizationLayerPSMPackage.ANN_HTTP_ACTIVITY_HANDLER__ANNOTATES_HTTP_ACTIVITY_HANDLER:
