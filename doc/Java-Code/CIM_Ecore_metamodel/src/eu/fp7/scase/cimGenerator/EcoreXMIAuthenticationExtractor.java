...
public class EcoreXMIAuthenticationExtractor{
	...
	public EcoreXMIAuthenticationExtractor(String strProjectName){
		...
		oURI = URI.createFileURI(new File(this.strProjectName + "AuthenticationCIM.xmi").getAbsolutePath());
	...
	public void exportEcoreXMI(AnnotationModel oAuthenticationCIM){
			this.oEcoreResource.getContents().add(oAuthenticationCIM);
