 ...
 * <ul>
 *   <li>{@link SearchLayerPSM.impl.AnnHTTPActivityImpl#getAnnotatesHTTPActivity <em>Annotates HTTP Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnHTTPActivityImpl extends AnnotatedElementImpl implements AnnHTTPActivity {
	...
	protected EClass eStaticClass() {
		return SearchLayerPSMPackage.Literals.ANN_HTTP_ACTIVITY;
	}
		...
		if (annotatesHTTPActivity != null && annotatesHTTPActivity.eIsProxy()) {
			...
			if (annotatesHTTPActivity != oldAnnotatesHTTPActivity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SearchLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY, oldAnnotatesHTTPActivity, annotatesHTTPActivity));
			}
		}
	...
	public void setAnnotatesHTTPActivity(HTTPActivity newAnnotatesHTTPActivity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SearchLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY, oldAnnotatesHTTPActivity, annotatesHTTPActivity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SearchLayerPSMPackage.ANN_HTTP_ACTIVITY__ANNOTATES_HTTP_ACTIVITY:
