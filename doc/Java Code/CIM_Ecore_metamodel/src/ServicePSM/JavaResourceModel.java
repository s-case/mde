 ...
 * <ul>
 *   <li>{@link ServicePSM.JavaResourceModel#getJavaRModelHasJAXBAnnotation <em>Java RModel Has JAXB Annotation</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getJavaRModelHasProperty <em>Java RModel Has Property</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getHasRelatedJavaRMManager <em>Has Related Java RM Manager</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getJavaRModelHasHibernateAnnotation <em>Java RModel Has Hibernate Annotation</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getJavaRModelHasSetter <em>Java RModel Has Setter</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getJavaRModelHasGetter <em>Java RModel Has Getter</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getHasRelatedJavaAlgoModel <em>Has Related Java Algo Model</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceModel#getParentName <em>Parent Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel()
...
public interface JavaResourceModel extends EObject {
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_JavaRModelHasJAXBAnnotation()
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceModel#getJavaRModelHasJAXBAnnotation <em>Java RModel Has JAXB Annotation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ServicePSM.PSMComponentProperty}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_JavaRModelHasProperty()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link ServicePSM.JavaResourceModelManager}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_HasRelatedJavaRMManager()
	 * @model
	 * @generated
	 */
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_JavaRModelHasHibernateAnnotation()
	 ...
	 * The list contents are of type {@link ServicePSM.JavaSetterFunction}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_JavaRModelHasSetter()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link ServicePSM.JavaGetterFunction}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_JavaRModelHasGetter()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_HasRelatedJavaAlgoModel()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setName(String)
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceModel#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceModel_ParentName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceModel#getParentName <em>Parent Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
