 ...
 * <ul>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getJavaRCManagerHasJAXRSAnnotation <em>Java RC Manager Has JAXRS Annotation</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getJavaRCManagerHasHTTPActivity <em>Java RC Manager Has HTTP Activity</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getHasAssociatedRMManager <em>Has Associated RM Manager</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getName <em>Name</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getControllerURI <em>Controller URI</em>}</li>
 *   <li>{@link ServicePSM.JavaResourceControllerManager#getParentName <em>Parent Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager()
...
public interface JavaResourceControllerManager extends EObject {
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_JavaRCManagerHasJAXRSAnnotation()
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceControllerManager#getJavaRCManagerHasJAXRSAnnotation <em>Java RC Manager Has JAXRS Annotation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ServicePSM.HTTPActivity}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_JavaRCManagerHasHTTPActivity()
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_HasAssociatedRMManager()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceControllerManager#getHasAssociatedRMManager <em>Has Associated RM Manager</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceControllerManager#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_ControllerURI()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceControllerManager#getControllerURI <em>Controller URI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ServicePSM.RESTfulServicePSMPackage#getJavaResourceControllerManager_ParentName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ServicePSM.JavaResourceControllerManager#getParentName <em>Parent Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
