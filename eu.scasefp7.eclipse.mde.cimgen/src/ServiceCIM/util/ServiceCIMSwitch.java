 ...
 * @generated
 */
public class ServiceCIMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServiceCIMPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceCIMPackage.CRUD_ACTIVITY: {
				CRUDActivity crudActivity = (CRUDActivity)theEObject;
				T result = caseCRUDActivity(crudActivity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceCIMPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceCIMPackage.INPUT_REPRESENTATION: {
			...
			case ServiceCIMPackage.OUTPUT_REPRESENTATION: {
			...
			case ServiceCIMPackage.RES_TFUL_SERVICE_CIM: {
				RESTfulServiceCIM resTfulServiceCIM = (RESTfulServiceCIM)theEObject;
				T result = caseRESTfulServiceCIM(resTfulServiceCIM);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>RES Tful Service CIM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>RES Tful Service CIM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRESTfulServiceCIM(RESTfulServiceCIM object) {
		return null;
	}
