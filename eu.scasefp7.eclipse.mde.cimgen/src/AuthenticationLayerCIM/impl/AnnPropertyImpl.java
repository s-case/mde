 ...
 * <ul>
 *   <li>{@link AuthenticationLayerCIM.impl.AnnPropertyImpl#getAnnotatesProperty <em>Annotates Property</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnPropertyImpl extends AnnotatedElementImpl implements AnnProperty {
	...
	protected EClass eStaticClass() {
		return AuthenticationLayerCIMPackage.Literals.ANN_PROPERTY;
	}
		...
		if (annotatesProperty != null && annotatesProperty.eIsProxy()) {
			...
			if (annotatesProperty != oldAnnotatesProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AuthenticationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY, oldAnnotatesProperty, annotatesProperty));
			}
		}
	...
	public void setAnnotatesProperty(Property newAnnotatesProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthenticationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY, oldAnnotatesProperty, annotatesProperty));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthenticationLayerCIMPackage.ANN_PROPERTY__ANNOTATES_PROPERTY:
