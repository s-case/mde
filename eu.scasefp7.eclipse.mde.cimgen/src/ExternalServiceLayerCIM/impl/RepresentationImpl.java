 ...
 * <ul>
 *   <li>{@link ExternalServiceLayerCIM.impl.RepresentationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepresentationImpl extends MinimalEObjectImpl.Container implements Representation {
	...
	protected EClass eStaticClass() {
		return ExternalServiceLayerCIMPackage.Literals.REPRESENTATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExternalServiceLayerCIMPackage.REPRESENTATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExternalServiceLayerCIMPackage.REPRESENTATION__NAME:
				return getName();
		}
