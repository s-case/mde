...
public class SourceColumnImpl extends MinimalEObjectImpl.Container implements SourceColumn {
	...
	protected EClass eStaticClass() {
		return MDEMigratorCIMMetamodelPackage.Literals.SOURCE_COLUMN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.SOURCE_COLUMN__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.SOURCE_COLUMN__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MDEMigratorCIMMetamodelPackage.SOURCE_COLUMN__NAME:
				return getName();
