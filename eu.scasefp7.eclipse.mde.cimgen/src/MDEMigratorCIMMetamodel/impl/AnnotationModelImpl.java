 ...
 *   <li>{@link MDEMigratorCIMMetamodel.impl.AnnotationModelImpl#getStrDBName <em>Str DB Name</em>}</li>
 *   <li>{@link MDEMigratorCIMMetamodel.impl.AnnotationModelImpl#getStrDBURL <em>Str DBURL</em>}</li>
 *   <li>{@link MDEMigratorCIMMetamodel.impl.AnnotationModelImpl#getStrDBType <em>Str DB Type</em>}</li>
...
public class AnnotationModelImpl extends MinimalEObjectImpl.Container implements AnnotationModel {
	...
	protected EClass eStaticClass() {
		return MDEMigratorCIMMetamodelPackage.Literals.ANNOTATION_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__NAME, oldName, name));
	}
	...
	public EList<Annotation> getHasAnnotation() {
		if (hasAnnotation == null) {
			hasAnnotation = new EObjectContainmentEList<Annotation>(Annotation.class, this, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__HAS_ANNOTATION);
		}
	...
	public void setStrDBName(String newStrDBName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_NAME, oldStrDBName, strDBName));
	}
	...
	public void setStrDBURL(String newStrDBURL) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DBURL, oldStrDBURL, strDBURL));
	}
	...
	public void setStrDBType(String newStrDBType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_TYPE, oldStrDBType, strDBType));
	}
	...
	public void setStrDBUsername(String newStrDBUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_USERNAME, oldStrDBUsername, strDBUsername));
	}
	...
	public void setStrDBPassword(String newStrDBPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_PASSWORD, oldStrDBPassword, strDBPassword));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__HAS_ANNOTATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__NAME:
				return getName();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__HAS_ANNOTATION:
				return getHasAnnotation();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_NAME:
				return getStrDBName();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DBURL:
				return getStrDBURL();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_TYPE:
				return getStrDBType();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_USERNAME:
				return getStrDBUsername();
			case MDEMigratorCIMMetamodelPackage.ANNOTATION_MODEL__STR_DB_PASSWORD:
