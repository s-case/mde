...
public class EcoreXMIExtractor{
	...
	public EcoreXMIExtractor(String strOutputFolder, String strProjectName){
		...
		oURI = URI.createFileURI(new File(this.strOutputFolder + "/CIMModels/" + this.strProjectName + "CIM.xmi").getAbsolutePath());
	...
	public void exportEcoreXMI(RESTfulServiceCIM oRESTfulServiceCIM){
			this.oEcoreResource.getContents().add(oRESTfulServiceCIM);
