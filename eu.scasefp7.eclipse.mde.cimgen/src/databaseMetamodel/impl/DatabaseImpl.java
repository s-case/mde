 ...
 * </p>
 * <ul>
 *   <li>{@link databaseMetamodel.impl.DatabaseImpl#getRelation <em>Relation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatabaseImpl extends MinimalEObjectImpl.Container implements Database {
	...
	protected EClass eStaticClass() {
		return DatabaseMetamodelPackage.Literals.DATABASE;
	}
	...
	public EList<Relation> getRelation() {
		if (relation == null) {
			relation = new EObjectContainmentEList<Relation>(Relation.class, this, DatabaseMetamodelPackage.DATABASE__RELATION);
		}
		return relation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DatabaseMetamodelPackage.DATABASE__RELATION:
